...
class Semester(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(fields=['year', 'period'], name='unique-semester')
        ]
...
class Course(models.Model):
    ...
    class Meta:
        ...
        constraints = [
            UniqueConstraint(fields=['course_number', 'course_name'], name='unique-course')
        ]
...
class Registration(models.Model):
    ...
    class Meta:
        ordering = ['registration_id', 'student', 'section']
